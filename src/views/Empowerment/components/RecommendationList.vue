...
import { devList, recommendationList } from "@/views/Empowerment/api/index";
import type { RecommendationType } from "@/views/Empowerment/api/types/index";
...
const getData = async () => {
  ...
  const res = await recommendationList({
