  ...
  <div class="stepForm">
    <div class="info">
      ...
      <span style="text-align: left"
        >将一个冗长或用户不熟悉的表单任务分成多个步骤，指导用户完成。</span
      >
    </div>
        ...
        <div class="grid-content bg-purple-dark">
          <el-card class="box-card">
            <template #header>
              <div class="card-header">
                <el-button class="button" type="text" @click="handleBack"
                  ><em class="el-icon-arrow-left" />返回</el-button
                >
            ...
            >
              <el-step
                title="填写转账信息"
                description="请仔细填写转账信息"
              ></el-step>
              <el-step
                title="确认转账信息"
                description="请仔细核对转账信息"
              ></el-step>
            ...
            <template v-if="active == 0">
              ...
              >
                ...
                <el-form-item label="转账金额" prop="transferNum">
                  <el-input
                    v-model.number="ruleForm.transferNum"
            ...
            <template v-else-if="active == 1">
              ...
              >
                ...
                <el-form-item label="付款人姓名" prop="payAccountNo">
                  <el-input
                    v-model="ruleForm.accAccountName"
                    readonly
                  ></el-input>
                </el-form-item>
            ...
            <template v-else-if="active == 3">
              ...
              >
                <template #extra>
                  <el-button type="primary" size="medium" @click="handleRedo"
                    >再转一笔</el-button
                  >
                </template>
              </el-result>
